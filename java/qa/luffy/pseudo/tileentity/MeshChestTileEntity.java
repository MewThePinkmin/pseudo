...
public class MeshChestTileEntity extends LockableLootTileEntity implements INamedContainerProvider {
    ...
    public MeshChestTileEntity(TileEntityType<?> typeIn) {
        super(typeIn);
    }

    public MeshChestTileEntity() {
        this(Registration.MESH_CHEST_TILE.get());
    }
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.mesh_chest");
    }
    ...
    protected void onOpenOrClose() {
        ...
        if (block instanceof MeshChestBlock) {
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos pos) {
        ...
        if (blockstate.hasTileEntity()) {
            ...
            if (tileentity instanceof MeshChestTileEntity) {
                return ((MeshChestTileEntity) tileentity).numPlayersUsing;
            }
        }
        return 0;
    }

    public static void swapContents(MeshChestTileEntity te, MeshChestTileEntity otherTe) {
